...
import org.oregonstate.droidperm.traversal.CheckerAnalysis;
...
public class JaxbUtil {
     ...
     */
    public static JaxbCallbackList buildJaxbData(MethodPermDetector detector, CheckerAnalysis checkerAnalysis) {
        ...
        Table<MethodOrMethodContext, String, CheckerUsageStatus> callbackCheckerStatusMap =
                checkerAnalysis.buildCheckerStatusMap();
                ...
                if (!sensEdges.isEmpty()) {
                    ...
                    Map<String, Boolean> permGaurdedMap = permSet.stream()
                            .collect(Collectors.toMap(perm -> perm,
                                    perm -> checkerAnalysis
                                            .getPermCheckStatusForAll(Collections.singletonList(perm), callback) ==
                                            CheckerAnalysis.PermCheckStatus.CHECK_DETECTED));
